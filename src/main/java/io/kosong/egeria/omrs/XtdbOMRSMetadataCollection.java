...
/*
 * This code is adapted from Egeria GraphOMRSMetadataCollection
 * https://github.com/odpi/egeria/blob/master/open-metadata-implementation/adapters/open-connectors/repository-services-connectors/open-metadata-collection-store-connectors/graph-repository-connector/src/main/java/org/odpi/openmetadata/adapters/repositoryservices/graphrepository/repositoryconnector/GraphOMRSMetadataCollection.java
 */
...
public class XtdbOMRSMetadataCollection extends OMRSDynamicTypeMetadataCollectionBase {
    ...
    XtdbOMRSMetadataCollection(XtdbOMRSRepositoryConnector parentConnector,
        ...
        try {
            ...
            ExceptionMessageDefinition messageDefinition = GraphOMRSErrorCode.CANNOT_OPEN_GRAPH_DB.getMessageDefinition();
            String className = "";
            String actionDescription = "";
            throw new RepositoryErrorException(messageDefinition, className, actionDescription, t);
        }
    }
